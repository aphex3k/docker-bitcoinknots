...
LABEL org.opencontainers.image.source="https://github.com/aphex3k/docker-bitcoinknots"
LABEL org.opencontainers.image.description="💰 Bitcoin Knots Docker image that runs the Bitcoin Knots node variant in a container for easy deployment"
...
RUN apt-get update \
    && apt-get install -y --no-install-recommends gosu libatomic1 \
